...
--
-- CORREÇÕES vs. o rascunho do prompt (schema real conferido):
--   • a coluna de UF é profiles.ESTADO (não existe profiles.uf);
--   • CPF vive em revendedora_docs.cpf (não em profiles.cpf).
--
-- Rodar no SQL Editor. Depois RE-RODAR o RLS-policies.sql inteiro (o trigger
