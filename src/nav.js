...
export const PANEIS_STAFF = ['financeiro','calculadora','clientes','bonus','fidelidade','funcionarios','perfis','formas-pagamento','categorias-financeiras','produtos','categorias','colecoes','fornecedores','faixas-comissao','config-raspadinha','precificacao','entrada-mercadoria','lancador'];
