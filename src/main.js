...
import { loadProdutos, produtoNovo, produtoEditar, produtoVoltarLista, produtoFiltrar, produtoFiltrarColecao, produtoFiltrarCategoria, produtoFiltrarFornecedor, produtoFiltrarCaracteristica, produtoPagina, produtoToggleGrupo, produtoSalvar, produtoExcluir, produtoToggleVariacao, produtoVarAdicionar, produtoVarRemover, produtoVarSet, produtoNovoFornecedor, maskMoneyProduto, produtoImportarBling, produtoImportBlingPreview, produtoImportBlingRun, produtoImportBlingParar, produtoImgAdd, produtoImgRemover, produtoImgPrincipal, produtoZoomFoto, produtoImportFotos, produtoFotosSelecionar, produtoFotosToggleSubstituir, produtoFotosImportar, produtoPlanilha, produtoPlanilhaModelo, produtoPlanilhaExportar, produtoPlanilhaArquivo, produtoPlanilhaToggleCriar, produtoPlanilhaAplicar, produtoPrecifPreview, produtoUsarSugerido, produtoCategoriaBanho } from './produtos.js';
...
Object.assign(window, { renderAprovadas, renderGarantiaCard, ehAdmin, ehStaff, ehGestor, loadDashboard, loadGarantias, loadConsignados, loadVendas, loadHistorico, loadTrocasDashboard, loadAdmin, loadFinanceiro, loadCalculadora, loadClientes, clienteBuscar, clienteVer, clienteNovo, clienteEditar, clienteSalvar, clienteExcluir, loadBonus, bonusFiltro, loadMarketing, loadFidelidade, loadFuncionarios, loadFormasPagamento, loadCategoriasFinanceiras, sb, abrirCicloRev, abrirFinalizarVenda, abrirHistoricoCiclo, adicionarAoCarrinho, ajustarValorPago, aprovarRev, atualizarMaleta, atualizarStatusCard, atualizarTotalVenda, buscarBling, calcPrazoGarantia, closeModal, confirmarExclusaoRev, confirmarMaleta, confirmarVendaCarrinho, definirPapel, marcarRevTeste, deletarCicloRev, detectarBlingId, editarGarantia, enviarLinkRecuperacao, escolherBlingCandidato, excluirGarantia, excluirRevendedora, excluirVenda, fazerCadastro, fazerLogin, fecharConfirma, fecharPrint, filtrarBling, filtrarGarantias, filtrarHistorico, finalizarCicloRev, gerarPdfFechamento, importarItensBling, loginGoogle, maskDateBR, maskDiaMes, maskMoneyBR, maskTelBR, mostrarRecuperar, mudarStatus, openBlingSync, openBuscaPeca, openFechamento, openNovaGarantia, openNovoConsignado, openVenda, previewFoto, previewMaletaPorId, registrarPagamento, zapCobrancaCliente, removerDoCarrinho, renderBuscaPeca, renderCicloGrid, cicloBuscar, cicloOrdenar, revogarRev, salvarBlingId, salvarComplemento, salvarConsignado, salvarGarantia, salvarNovaSenha, setGFilter, setPFilter, setTrocaFiltro, resolverTroca, trocaBuscar, showPanel, toggleSidebarLateral, atualizarBreadcrumb, revBuscar, revChip, sortConsignados, sortGarantiasStaff, toggleCicloSoVendidos, toggleCicloSoNaoVendidos, abrirConferencia, abrirConferenciaCorrecao, salvarCorrecaoConferencia, renderConferencia, confMarcarDevolvido, confBuscaTeclas, confVerFoto, confComissaoEditada, confComissaoUsarFaixa, lightboxFotoNav, conferirFechamento, finalizarAposConferencia, baixarPdfMostruario, switchTab, toggleCadastros, toggleHistorico, toggleOrdemTroca, verGarantia, verItensBling, verRevendedora, novaRevendedora, abrirFormRev, salvarRevendedora, revCepBlur, fiadorCepBlur, cadastroCompletoParaContrato, gerarContrato, contratoTentarSair, contratoResolver, contratoAtualizarBtn, maskCpf, maskCep, verVenda, voltarCardsCiclo, voltarHistoricoCiclo, voltarListaBling, voltarLogin,
  loadProdutos, produtoNovo, produtoEditar, produtoVoltarLista, produtoFiltrar, produtoFiltrarColecao, produtoFiltrarCategoria, produtoFiltrarFornecedor, produtoFiltrarCaracteristica, produtoPagina, produtoToggleGrupo, produtoSalvar, produtoExcluir, produtoToggleVariacao, produtoVarAdicionar, produtoVarRemover, produtoVarSet, produtoNovoFornecedor, maskMoneyProduto, produtoImportarBling, produtoImportBlingPreview, produtoImportBlingRun, produtoImportBlingParar, produtoImgAdd, produtoImgRemover, produtoImgPrincipal, produtoZoomFoto, produtoImportFotos, produtoFotosSelecionar, produtoFotosToggleSubstituir, produtoFotosImportar, produtoPlanilha, produtoPlanilhaModelo, produtoPlanilhaExportar, produtoPlanilhaArquivo, produtoPlanilhaToggleCriar, produtoPlanilhaAplicar, produtoPrecifPreview, produtoUsarSugerido, produtoCategoriaBanho,
