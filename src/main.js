...
import { loadAdmin, renderAprovadas, revBuscar, revChip, verRevendedora, aprovarRev, revogarRev, enviarAcessoRev, criarAcessoRev, definirPapel, marcarRevTeste, marcarPodeCompletarVendas, confirmarExclusaoRev, excluirRevendedora, novaRevendedora, abrirFormRev, salvarRevendedora, revCepBlur, fiadorCepBlur, cadastroCompletoParaContrato, gerarContrato, contratoTentarSair, contratoResolver, contratoAtualizarBtn, promoverFuncionaria, promoverConfirmar, removerDaListaRevendedoras, revTrocarAba, revFechamentoAbrir, revFechamentoVoltar } from './admin.js';
