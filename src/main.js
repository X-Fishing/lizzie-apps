...
import { loadAdmin, renderAprovadas, revBuscar, revChip, verRevendedora, aprovarRev, revogarRev, definirPapel, marcarRevTeste, confirmarExclusaoRev, excluirRevendedora, novaRevendedora, abrirFormRev, salvarRevendedora, revCepBlur, fiadorCepBlur, cadastroCompletoParaContrato, gerarContrato, contratoTentarSair, contratoResolver, contratoAtualizarBtn } from './admin.js';
