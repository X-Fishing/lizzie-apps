...
import { loadAdmin, renderAprovadas, verRevendedora, aprovarRev, revogarRev, definirPapel, marcarRevTeste, confirmarExclusaoRev, excluirRevendedora, novaRevendedora, abrirFormRev, salvarRevendedora, revCepBlur, fiadorCepBlur, cadastroCompletoParaContrato, gerarContrato } from './admin.js';
